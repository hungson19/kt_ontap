...
public final class InputMethods {
    private static final String ERROR_ALERT = "===>> Định dạng không hợp lệ! Vui lòng nhập lại....";
    private static final String ERROR_DATE = "===>> Định dạng không hợp lệ (dd/MM/yyyy)! Vui lòng nhập lại....";
    private static final String EMPTY_ALERT = "===>> Không thể để trống! Vui lòng nhập lại....";
    /*========================================Input Method Start========================================*/
